...
gal_x, gal_y, gal_z = SubhaloCM from the TNG data access site, in comoving kpc 
rh = Group_R_Crit200from (halo virial radius R_200,c) from the TNG data access site, in comoving kpc 
...
spin_x, spin_y, spin_z = SubhaloSpin (total spin of all particles) from the TNG data access site, in units of kpc*(km/s)
...
d_node_mcpm = comoving distance of a galaxy to the nearest cosmic web node, as identified by DisPerSE from the MCPM density field, in comoving kpc
d_fil_mcpm = transverse comoving distance of a galaxy to the nearest cosmic web filament spine, as identified by DisPerSE from the MCPM density field, in comoving kpc
...
ngal_1000, ngal_2000, ngal_5000 = Number of galaxies + 1 within spheres of radii 1000, 2000, and 5000 comoving Mpc
